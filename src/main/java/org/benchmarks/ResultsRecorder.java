...
public class ResultsRecorder implements TimeRecorder {
    ...
    public ResultsRecorder(BenchmarkConfig config, double highBound, int percentOfHighBound, double targetRate, int retry, int totalTime) throws IOException {
        ...
        String respHdrFile = String.format("%s/response_time_%d_%s_%d.hgrm", config.getHistogramsDir(), percentOfHighBound, FormatTool.format(targetRate), retry);
        ...
        String servHdrFile = String.format("%s/service_time_%d_%s_%d.hgrm", config.getHistogramsDir(), percentOfHighBound, FormatTool.format(targetRate), retry);
        ...
        String errorsHdrFile = String.format("%s/errors_%d_%s_%d.hgrm", config.getHistogramsDir(), percentOfHighBound, FormatTool.format(targetRate), retry);
